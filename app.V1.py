    ...
    if actual_db < min_required_db:
        ...
        for premium in range(50000, 150001, 25000):
            for years in range(4, 11):
                required_min_db = int((premium * years) / 0.20)
                for db in range(required_min_db, required_min_db + 2000001, 250000):
                    ...
                    print(
                        f"Trying: Premium={premium}, Years={years}, DB={db} | GPT Fail={gpt_fail}, TEFRA Fail={tefra_fail}, Lapsed={lapsed}")
